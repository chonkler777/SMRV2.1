      ...
      <div className="flex justify-between items-center">
        <div className="flex space-x-6 items-center">
          <div className="flex gap-5 items-start">
            ...
            <div className="relative hidden lg:flex flex-col justify-center h-full group">

              <div className="flex items-center gap-6">
                <h1 className="flex items-center text-white font-montserrat text-[28px] font-extrabold gap-2 leading-none">
                  <span>CHONK</span>
                ...
                <span className="flex items-center gap-1 font-roboto text-[20px] font-bold text-white">
                  <TrendlineSvg />
              ...
              <span className="font-roboto text-[12px] text-[#C3C8CC] whitespace-nowrap mt-0.5">
